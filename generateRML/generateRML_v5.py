...
# has authorized access point for expression
P20313_list = [
"ex:ExpressionMap rr:predicateObjectMap [",
"  rr:predicate rdfs:label;",
"  rr:objectMap [",
"    rml:reference \"P20313[@lang]\";",
"    rr:termType rr:Literal;",
"    rml:languageMap [",
"      rml:reference \"P20313/@lang\"",
"    ]",
...
#has variant access point for expression
P20314_list = [
"ex:ExpressionMap rr:predicateObjectMap [",
"  rr:predicate bf:identifiedBy;",
"  rr:objectMap [",
...
# has authorized access point for manifestation
P30294_list = [
"ex:ManifestationMap rr:predicateObjectMap [",
"  rr:predicate rdfs:label;",
"  rr:objectMap [",
...
# has variant access point for manifestation
P30295_list = [
"ex:ManifestationMap rr:predicateObjectMap [",
"  rr:predicate bf:identifiedBy;",
"  rr:objectMap [",
...
# has authorized access point for item
P40083_list = [
"ex:ItemMap rr:predicateObjectMap [",
"  rr:predicate rdfs:label;",
"  rr:objectMap [",
...
# has variant access point for item
P40084_list = [
"ex:ItemMap rr:predicateObjectMap [",
"  rr:predicate bf:identifiedBy;",
"  rr:objectMap [",
...
def start_RML_map(entity):
	...
	if entity == "work":
		for line in P10002_list:
			RML_list.append(line + "\n")
		for line in P10331_list:
			RML_list.append(line + "\n")
		for line in P10332_list:
			RML_list.append(line + "\n")
	elif entity == "expression":
		for line in P20313_list:
			RML_list.append(line + "\n")
		for line in P20314_list:
			RML_list.append(line + "\n")
	elif entity == "manifestation":
		for line in P30294_list:
			RML_list.append(line + "\n")
		for line in P30295_list:
			RML_list.append(line + "\n")
	elif entity == "item":
		for line in P40083_list:
			RML_list.append(line + "\n")
		for line in P40084_list:
			RML_list.append(line + "\n")
