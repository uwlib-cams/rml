...
if num_of_works == 0: # if no records are found (some issue has occurred)
    ...
    for work in workList:
        ...
        workGraph.serialize(destination=f'input/{currentDate}/work/' + label + '.xml', format="xml") # serializes in xml
...
if num_of_expressions == 0:
    ...
    for expression in expressionList:
        ...
        expressionGraph.serialize(destination=f'input/{currentDate}/expression/' + label + '.xml', format="xml")
...
if num_of_manifestations == 0:
    ...
    for manifestation in manifestationList:
        ...
        manifestationGraph.serialize(destination=f'input/{currentDate}/manifestation/' + label + '.xml', format="xml")
...
if num_of_items == 0:
    ...
    for item in itemList:
        ...
        label = item.split('/')[-1]
        itemGraph.serialize(destination=f'input/{currentDate}/item/' + label + '.xml', format="xml")
...
workPermissionList = os.listdir(f'input/{currentDate}/work/')

for work in workPermissionList:
    os.system(f"chmod u+rwx input/{currentDate}/work/{work}")
...
expressionPermissionList = os.listdir(f'input/{currentDate}/expression/')

for expression in expressionPermissionList:
    os.system(f"chmod u+rwx input/{currentDate}/expression/{expression}")
...
manifestationPermissionList = os.listdir(f'input/{currentDate}/manifestation/')

for manifestation in manifestationPermissionList:
    os.system(f"chmod u+rwx input/{currentDate}/manifestation/{manifestation}")
...
itemPermissionList = os.listdir(f'input/{currentDate}/item/')

for item in itemPermissionList:
    os.system(f"chmod u+rwx input/{currentDate}/item/{item}")
