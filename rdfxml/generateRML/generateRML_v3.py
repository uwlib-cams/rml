...
for number in property_range:
    ...
    for map in kiegel_list:
        ...
        elif len(map_list) > 1: # yes
            predicate_name = map_list[0] # contribution

            semicolon_test = False # yes

            for item in map_list:
                if item == ";":
                    semicolon_test = True

            if semicolon_test == True: # no
                print("CODE MISSING: 269")

            else:
                if map_list[1] == ">>": # yes
                    # generate a predicate-object map that opens a blank node
                    bnode_map_name = predicate_name.capitalize() + "_" + str(bnode_map_number) + "_" # Contribution#Map
                    ...
                    class_name = map_list[2] # Contribution
                    ...
                    # [ role=<>, >, agent, >>, Person, >, rdfs:label]

                    start_bnode_here = 0

                    for num in rest_of_mapping:
                        item = map_list[num] # map_list[4] = role=<> # map_list[5] = > # map_list[6] = agent # map_list[7] = >>
                        ...
                        elif item == ">>": # blank node within a blank node # 7 goes here
                            start_bnode_here = num - 1 # 6
                            break

                        else: # 6 goes here
                            pass

                    if start_bnode_here > 0: # opening a blank node within a blank node # 6
                        predicate_name = map_list[start_bnode_here] # map_list[6] = agent
                        ...
                        class_name = map_list[start_bnode_here + 2] # because + 1 would be the >> # map_list[8] = Person
                        ...
                        rest_of_mapping_2 = range(start_bnode_here+4, len(map_list)) # range(10, 11)
                        ...
                        for num in rest_of_mapping_2:
                            ...
                            if item == ">":
                                ...
                                print("CODE MISSING: 389")

                            else:
                                pass
                else:
                    print("CODE MISSING: 394")
