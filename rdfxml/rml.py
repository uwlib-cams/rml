...
for manifestation in manifestationList:
    ...
    os.system(f"java -jar rmlmapper-4.8.1-r262.jar -m ~/rml/rdfxml/generateRML/rmlOutput/manifestationRML.ttl -o {label}.nq") # run RML, output as nquad file
    manifestationGraph = Graph()
...
for item in itemList:
    ...
    os.system(f"java -jar rmlmapper-4.8.1-r262.jar -m ~/rml/rdfxml/generateRML/rmlOutput/itemRML.ttl -o {label}.nq") # run RML, output as nquad file
    itemGraph = Graph()
